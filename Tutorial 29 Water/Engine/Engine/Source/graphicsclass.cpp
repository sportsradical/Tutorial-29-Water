...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_GroundModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/ground01.tga", "../Engine/data/ground.txt");
	if(!result)
	{
	...
	result = m_WallModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/wall01.tga", "../Engine/data/wall.txt");
	if(!result)
	{
	...
	result = m_BathModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/marble01.tga", "../Engine/data/bath.txt");
	if(!result)
	{
	...
	result = m_WaterModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/water02.tga", "../Engine/data/water.txt");
	if(!result)
	{
